            ...
            <form
                ...
                <div className="w-full">
                    ...
                    <Input
                        ...
                        id="email"
                        placeholder="Email"
                        className="w-full h-10 border border-solid border-black rounded p-2 placeholder:text-gray-400"
                        name="email"
                        aria-label="Email"
                        required
                    />
                ...
                <div className="w-full">
                    ...
                    <div className="relative">
                        <Input
                            ...
                            className="w-full h-10 border border-solid border-black rounded p-2 pr-10 placeholder:text-gray-400"
                            name="password"
                            aria-label="Password"
                            required
                        />
                ...
                <Button 
                    type="submit" 
                    className="w-full bg-black text-white hover:bg-white hover:text-black transition-colors duration-300 mt-6 p-2"
                    disabled={isLoading}
                >
